...
public interface IRMI_Defs {
	 ...
	 */
	public static final int SERVER_REGISTRY_PORT = 2098;
	public static final int CLIENT_REGISTRY_PORT = 2099;

	/**
	 * Port used by the class server on the Server side.
	 */
	public static final int CLASS_SERVER_PORT = 2001;
	 ...
	 */
	public static final int CLASS_CLIENT_PORT = 2002;
