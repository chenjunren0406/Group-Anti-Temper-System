...
public interface IRMIUtils {
	 ...
	 */
	public abstract Registry getLocalRegistry(int port);
	 ...
	 */
	public abstract Registry getRemoteRegistry(String host, int port);
	 ...
	 */
	public abstract String startRMI(int classServerPort, boolean isServer);
